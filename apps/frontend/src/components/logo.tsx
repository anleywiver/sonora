// Brand mark: equalizer/soundwave bars on the accent→primary gradient
// badge already used across the design system (docs/design-system.md).
// Inline SVG (not <img src="/icon.svg">) so it always renders crisp and
// themes with currentColor if ever needed, without an extra request.
